...
const Sidebar = () =>  {
    return (
        <div>
            <Link to = "/dashboard"><button className = " w ml-10 mt-1 rounded-lg shadow bg-blue-400 font-bold  hover:bg-green-600 hover:scale-50" >Add <AddCircleIcon className = "text-white bg-blue-600 rounded-lg hover:bg-blue-500 hover:scale-50" /></button></Link><br/>
